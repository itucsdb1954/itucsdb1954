...
#course
    def add_course(self,course):
        with dbapi2.connect(self.dbfile) as connection:
            ...
            query = "INSERT INTO courses (department, name, lecturerName, description, VF_conditions) VALUES (%s, %s, %s, %s, %s)"
    ...
    def get_course(self,course_key):
        with dbapi2.connect(self.dbfile) as connection:
            cursor = connection.cursor()
            query = "SELECT department, name, lecturerName, description, VF_conditions FROM courses WHERE (id = %s)"
            cursor.execute(query, (course_key,))
    ...
    def get_courses(self):
        ...
        with dbapi2.connect(self.dbfile) as connection:
            cursor = connection.cursor()
            query = "SELECT id,department, name, lecturerName, description, VF_conditions FROM course ORDER BY ID"
    ...
    def update_course(self,course_key,Course):
        with dbapi2.connect(self.dbfile) as connection:
            cursor = connection.cursor()
            query = "UPDATE course SET department = %s, name = %s, lecturerName = %s, description = %s, VF_conditions = %s WHERE (ID = %s)"
...
#Midterm
    ...
    def delete_course(self,midterm_key):
        with dbapi2.connect(self.dbfile) as connection:
            cursor = connection.cursor()
    ...
    def get_midterm(self,midterm_key):
        with dbapi2.connect(self.dbfile) as connection:
            ...
            midterm_ = Midterm(number_of_midterm, midterm_weight,is_important)
...
#Homeworks
    ...
    def get_homework(self,homework_key):
        with dbapi2.connect(self.dbfile) as connection:
            ...
            homework_ = Homework(number_of_homework, homework_weight,is_important)
...
"""
	def update_homework(self,homework_key,Homework):
		with dbapi2.connect(self.dbfile) as connection:
			...
			cursor.execute(query, (Homework.number_of_homework,Homework.homework_weight,Homework.homework_score[0],Homework.homework_score[1],Homework.homework_score[2],Homework.homework_score[3],Homework.is_important, midterm_key))
			connection.commit()
		return homework_key
#project
    ...
    def get_project(self,project_key):
        with dbapi2.connect(self.dbfile) as connection:
            ...
            project_ = Project(number_of_project,project_weight,project_score1,project_score2,is_important)
    	return project_
...
#attendance
    ...
    def get_attendance(self,attendance_key):
        ...
        attendance_ = Attendance(upper_limit_percent,attendance_hour1,attendance_hour2,attendance_hour3,attendance_hour4,attendance_hour5,attendance_hour6,attendance_hour7,attendance_hour8,attendance_hour9,attendance_hour10,attendance_hour11,attendance_hour12,attendance_hour13,attendance_hour14,is_important)
        return attendance_
